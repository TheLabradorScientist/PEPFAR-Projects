...
function futureSimS3(calibBool , pIdx , paramsSub , paramSet , paramSetIdx , tstep_abc , date) 
%%
...
pathModifier = ['Kenya1DoseCea_Aug14_WaningCU_PEPFAR_S3']; % ***SET ME***: name for simulation output file
% Directory to save results
