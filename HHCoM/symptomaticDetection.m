						    ...
						    for a = 1 : age 
							    for r = 1 : risk
                                    if [( (x==1) && ((h==6) || (s==6)) ) || (x==2) || (x==3)] 
                             		    toSympTreat = screenAlgs{1}.ccTreatRetain; % proportion of women who move to treatment from symptoms
						...
						for a = 1 : age 
							for r = 1 : risk
                                if [( (x==1) && ((h==6) || (s==6)) ) || (x==2) || (x==3)] 
                                     ...
                                     toSympTreat = screenAlgs{1}.ccTreatRetain * (1 - hystMult(x)); % proportion of women who move to treatment from symptoms
                                     toSympTreatHyst = screenAlgs{1}.ccTreatRetain * hystMult(x); 
