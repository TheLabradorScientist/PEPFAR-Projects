function [vax, ccDeaths, hivDeaths, ccHealthState, hpvHealthState, newCC, totalPerAge, screenTreat, screenSympCCTreat, hivHealthState, newHiv, prepCov, newCirc] = vaxCEA_multSims_processResults_PEPFAR_S1(vaxResultInd , sceNum , fileNameNums, fileInds, vax, ccDeaths, hivDeaths, ccHealthState, hpvHealthState, newCC, totalPerAge, screenTreat, screenSympCCTreat, hivHealthState, newHiv, prepCov, newCirc)
...
baseFileName = ['VaccineKenyaPrEPCea_Mar14_PEPFARstop_S' , sceNum];
% Looping length 
...
screenAge = [8 10 6 7 8 9 10];
sceScreenInd = {[1, 5] [2, 7] 3 4 6}; 
