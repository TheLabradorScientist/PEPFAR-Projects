...
muCC = min(muCC .* 12 , 0.99); % convert undetected cervical cancer mortality rate from monthly to yearly
muCC_det = min(muCC_det .* 12 , 0.99); % convert detected cervical cancer mortality rate from monthly to yearly
...
lambdaMultImm(1 : 4,1) = 1 - 0.01;
lambdaMultImm(5 : 10,1) = 1 - logspace(log10(0.01) , log10(0.1) , 6);
lambdaMultImm(11 : age,1) = lambdaMultImm(10);
