function summNA_Results(year)
% read in data from model runs
%% Vaccination coverage
%CC Mortality
coverMort_Gen = readtable('General_CCMortality_VaxCover.csv');
coverMort_Neg = readtable('HIVNeg_CCMortality_VaxCover.csv');
coverMort_Art = readtable('VaxCover_ARTMort.csv');
coverMort_500 = readtable('VaxCover_CD4_500Mort.csv');
coverMort_500_350 = readtable('VaxCover_CD4_500_350Mort.csv');
coverMort_350_200 = readtable('VaxCover_CD4_350_200Mort.csv');
coverMort_200 = readtable('VaxCover_CD4_200Mort.csv');

% CC Incidence
coverInc_Gen = readtable('General_Incidence.csv');
coverInc_Neg = readtable('HIVNeg_Reduction.csv');
coverInc_Art = readtable('ART_Incidence.csv');
coverInc_500 = readtable('CD4_500_Incidence.csv');
coverInc_500_350 = readtable('CD4_500_350_Incidence.csv');
coverInc_350_200 = readtable('CD4_350_200_Incidence.csv');
coverInc_200 = readtable('CD4_200_Incidence.csv');

%% Vaccine waning
%CC Mortality
waneMort_Gen = readtable('waning_General_CCMortality.csv');
waneMort_Neg = readtable('waning_hivNegMortality.csv');
waneMort_Art = readtable('ARTMort.csv');
waneMort_500 = readtable('CD4_500Mort.csv');
waneMort_500_350 = readtable('CD4_500_350Mort.csv');
waneMort_350_200 = readtable('CD4_350_200Mort.csv');
waneMort_200 = readtable('CD4_200Mort.csv');

% CC Incidence
waneInc_Gen = readtable('GenInc_Waning.csv');
waneInc_Neg = readtable('HIVNeg_Waning.csv');
waneInc_Art = readtable('ART_Waning.csv');
waneInc_500 = readtable('CD4_500_Waning.csv');
waneInc_500_350 = readtable('CD4_500_350_Waning.csv');
waneInc_350_200 = readtable('CD4_350_200_Waning.csv');
waneInc_200 = readtable('CD4_200_Waning.csv');
