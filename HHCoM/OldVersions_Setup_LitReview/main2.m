...
parfor mult = 1 : size(vals , 2)
    ...
    kCC_Cin3 = kCC_Cin3_Orig .* vals(mult);
...
%     disp(['Reached year ' num2str(endYear)])
    ...
    filename = ['kCC_Cin3' , num2str(vals(mult)) , 'Mult' , '.mat']; %sprintf('test_output%d.mat' , n);
    parsave_nh(filename , tVec ,  popVec , newHiv ,...
        newImmHpv , newVaxHpv , newHpv , hivDeaths , ...
        deaths , newCC , artTreatTracker , startYear , endYear , popLast);
