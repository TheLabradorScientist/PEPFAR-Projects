...
function futureSimS4(calibBool , pIdx , paramsSub , paramSet , paramSetIdx , tstep_abc , date) 
%%
...
pathModifier = ['Kenya1DoseCea_Aug14_WaningCU_PEPFAR_S4']; % ***SET ME***: name for simulation output file
% Directory to save results
...
%             end 
        ...
        ode4xtra(@(t , pop) mixInfect_S4(t , pop , ...
