...
function vaxCEA_multSims_mainFunction_sce10(username)
...
loopSegments = {0 , round(2/2) , 7}; % running 10 scenarios ***SET ME***: the number of scenarios will be different
...
for j = [1] % FORTESTING
    ...
    [vax, deaths, ccHealthState, hpvHealthState, newCC, totalPerAge, screenTreat, screenSympCCTreat] = ...
        vaxCEA_multSims_processResults_sce10(1 , sceString , {'0'}, fileInds, vax, deaths, ccHealthState, hpvHealthState, newCC, totalPerAge, screenTreat, screenSympCCTreat);  
