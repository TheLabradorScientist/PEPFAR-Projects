...
function[stepsPerYear , timeStep , startYear , currYear , endYear , ...
    ...
    ccReghpvVaxInds_treat , ccDisthpvVaxInds_treat , vaxEff] = loadUp2_S4(fivYrAgeGrpsOn , calibBool , pIdx , paramsSub , paramSet , paramSetIdx)
...
maxRateM = [artVScov(:,3) ./ 100 ; 0.6482; 0.404; 0.404 ; 0.161; 0.6482] .* artOutMult; % S2 population-level ART coverage in males (72.9% if 90-90-90)
maxRateF = [artVScov(:,2) ./ 100 ; 0.6875; 0.429; 0.429 ; 0.170; 0.6875] .* artOutMult; % S2 population-level ART coverage in females (72.9% if 90-90-90)
